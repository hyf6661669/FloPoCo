...
\resizebox{!}{80pt}{
  \begin{tikzpicture}
    ...
    \footnotesize 
    \node[draw, blue!100,   ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel1)  at (49.8em, 52.7em) {} ;
    \node[draw, blue!100,   ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel2)  at (49.8em, 50.5em) {} ;
    \node[draw, blue!100,   ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel3)  at (49.8em, 48.2em) {} ;
    \node[draw, blue!100,   ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel4)  at (49.8em, 45.9em) {} ;
    \node[draw, blue!100,   ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel5)  at (49.8em, 43.7em) {} ;
    \node[draw, green!100,  ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel6)  at (49.8em, 41.4em) {} ;
    \node[draw, green!100,  ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel7)  at (49.8em, 39.1em) {} ;
    \node[draw, green!100,  ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel8)  at (49.8em, 36.8em) {} ;
    \node[draw, green!100,  ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel9)  at (49.8em, 34.6em) {} ;
    \node[draw, green!100,  ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel10) at (49.8em, 32.4em) {} ;
    \node[draw, red!100,    ultra thick, rectangle, minimum width = 3.4*34.5ex, minimum height=4.5ex] (sel11) at (49.8em, 30.5em) {} ;
...
%	\end{pmatrix}$
	...
	%input of x register
    \draw[hwbus, blue!100, ->]  (d6.south) -- ($(d6)-(0,2em)$) -- ($(n35)-(10,0ex)$) -- ($(n35)-(3,0)$) node[near start] {$/$} node[xshift=-0.9cm, yshift=0.5cm] {$x_1(k+1)$}  node[near end, right] {};
    \draw[hwbus, blue!100, ->]  (d7.south) -- ($(d7)-(0,1.5em)$) -- ($(n36)-(9,0ex)$) -- ($(n36)-(3,0)$) node[near start] {$/$} node[xshift=-0.9cm, yshift=0.5cm] {$x_2(k+1)$}  node[near end, left] {};
    \draw[hwbus, blue!100, ->]  (d8.south) -- ($(d8)-(0,1.5em)$) -- ($(n37)-(8,0ex)$) -- ($(n37)-(3,0)$) node[near start] {$/$} node[xshift=-0.9cm, yshift=0.5cm] {$x_3(k+1)$}  node[near end, left] {};
    \draw[hwbus, blue!100, ->]  (d9.south) -- ($(d9)-(0,2em)$) -- ($(n38)-(7,0ex)$) -- ($(n38)-(3,0)$) node[near start] {$/$} node[xshift=-0.9cm, yshift=0.5cm] {$x_4(k+1)$}  node[near end, left] {};
    \draw[hwbus, blue!100, ->]  (d10.south) -- ($(d10)-(0,2em)$) -- ($(n39)-(6,0ex)$) -- ($(n39)-(3,0)$) node[near start] {$/$} node[xshift=-0.9cm, yshift=0.5cm] {$x_5(k+1)$}  node[near end, left] {};

	%output of register to t
    \draw[hwbus, red1!100, ->]  (n35.east) -- ($(n35)+(10,0em)$) -- ($(n35)+(10,89ex)$) -- ($(n1)+(0,8ex)$) -- (n1.north) node[near start] {$/$} node[xshift=0.8cm, yshift=0.6cm] {$x_1(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n36.east) -- ($(n36)+(11,0em)$) -- ($(n36)+(11,98.5ex)$) -- ($(n3)+(0,15ex)$) -- (n3.north) node[near start] {$/$} node[xshift=0.8cm, yshift=1.8cm] {$x_2(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n37.east) -- ($(n37)+(12,0em)$) -- ($(n37)+(12,108ex)$) -- ($(n6)+(0,22ex)$) -- (n6.north) node[near start] {$/$} node[xshift=0.8cm, yshift=2.9cm] {$x_3(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n38.east) -- ($(n38)+(13,0em)$) -- ($(n38)+(13,117.5ex)$) -- ($(n10)+(0,33.5ex)$) -- (n10.north) node[near start] {$/$} node[xshift=0.8cm, yshift=4.8cm] {$x_4(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n39.east) -- ($(n39)+(14,0em)$) -- ($(n39)+(14,127ex)$) -- ($(n15)+(0,48ex)$) -- (n15.north) node[near start] {$/$} node[xshift=0.8cm, yshift=7.2cm] {$x_5(k)$}  node[near end,right] {};


	%output of register to x 
    \draw[hwbus, red1!100, ->]  (n35.east) -- ($(n35)+(10,0em)$) -- ($(n35)+(10,29ex)$) -- ($(n18)+(0,15ex)$) -- (n18.north) node[near start] {$/$} node[xshift=0.8cm, yshift=1.8cm] {$x_1(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n36.east) -- ($(n36)+(11,0em)$) -- ($(n36)+(11,39ex)$) -- ($(n22)+(0,29.5ex)$) -- (n22.north) node[near start] {$/$} node[xshift=0.8cm, yshift=4.0cm] {$x_2(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n37.east) -- ($(n37)+(12,0em)$) -- ($(n37)+(12,49ex)$) -- ($(n26)+(0,42.0ex)$) -- (n26.north) node[near start] {$/$} node[xshift=0.8cm, yshift=6.0cm] {$x_3(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n38.east) -- ($(n38)+(13,0em)$) -- ($(n38)+(13,59ex)$) -- ($(n30)+(0,54.5ex)$) -- (n30.north) node[near start] {$/$} node[xshift=0.8cm, yshift=8.0cm] {$x_4(k)$}  node[near end,right] {};
    \draw[hwbus, red1!100, ->]  (n39.east) -- ($(n39)+(14,0em)$) -- ($(n39)+(14,69ex)$) -- ($(n33)+(0,64.5ex)$) -- (n33.north) node[near start] {$/$} node[xshift=0.8cm, yshift=9.6cm] {$x_5(k)$}  node[near end,right] {};

	%inputs
    \draw[hwbus, orange1!100, ->]  ($(n19)+(0,35em)$) -- (n19.north) node[near start] {$/$} node[xshift=0.8cm, yshift=12.8cm] {$u_1(k)$}  node[near end,right] {};
    \draw[hwbus, orange1!100, ->]  ($(n23)+(0,42em)$) -- (n23.north) node[near start] {$/$} node[xshift=0.8cm, yshift=15.5cm] {$u_2(k)$}  node[near end,right] {};
    \draw[hwbus, orange1!100, ->]  ($(n27)+(0,48em)$) -- (n27.north) node[near start] {$/$} node[xshift=0.8cm, yshift=17.8cm] {$u_3(k)$}  node[near end,right] {};
    \draw[hwbus, orange1!100, ->]  ($(n31)+(0,54em)$) -- (n31.north) node[near start] {$/$} node[xshift=0.8cm, yshift=20.1cm] {$u_4(k)$}  node[near end,right] {};
    \draw[hwbus, orange1!100, ->]  ($(n34)+(0,59em)$) -- (n34.north) node[near start] {$/$} node[xshift=0.8cm, yshift=22.0cm] {$u_5(k)$}  node[near end,right] {};
