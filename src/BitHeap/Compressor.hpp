...
namespace flopoco
{
	...
	public:
		 ...
		 * 		if its not a variable compressor, middleLength = 0
		 */
		virtual unsigned int getHeightsAtColumn(unsigned int column, unsigned int middleLength = 0);
		 ...
		 * 		if its not a variable compressor, middleLength = 0
		 */
		virtual unsigned int getOutHeightsAtColumn(unsigned int column, unsigned int middleLength = 0);
