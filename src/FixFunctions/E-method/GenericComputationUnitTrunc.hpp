/*
 * GenericComputationUnittRUNC.hpp
 *
...
namespace flopoco {
	...
	class GenericComputationUnitTrunc : public Operator
	{
	public:
		/**
		 ...
		 */
		GenericComputationUnitTrunc(Target* target,
				size_t radix,
				int    maxDigit,
				size_t index,
				int    specialCase,
...
#endif /* _GENERICCOMPUTATIONUNITTRUNC_HPP_ */
