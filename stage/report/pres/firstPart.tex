	...
	\frametitle{Workflow}
		...
		\resizebox{300pt}{!}{
		  ...
		  \begin{tikzpicture}[]
		   ...
		   \node[draw, fill = gray!20, shape = rectangle, rounded corners,minimum width = 2cm, minimum height= 2cm] at (-4cm,4cm) {FixSIF} ;
		   \node[draw, fill = gray!20, shape = rectangle, rounded corners,minimum width = 1cm, minimum height= 1cm] at (0cm,4cm) {VHDL} ;
			...
			\draw (-3cm, 4cm) -- (-0.5cm,4cm) [->, thick] node[above,near start, text width = 3cm, align=center, xshift=-1cm]{};
			%zoom links
			\draw (-5cm, 3cm) -- (-9.5cm,1.5cm) [-, thick, black!40] node[above,near start, text width = 3cm, align=center, xshift=-1cm]{};
