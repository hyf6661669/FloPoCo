...
namespace flopoco {
    ...
    class Xilinx_TernaryAdd_2State_slice : public Operator {
      ...
      public:
        Xilinx_TernaryAdd_2State_slice( Operator *parentOp, Target *target, const unsigned int &wIn = 4, const bool &is_initial = false, const std::string &lut_content = "x\"69699696e8e8e8e8\"" );
