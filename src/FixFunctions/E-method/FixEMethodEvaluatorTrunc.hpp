/*
  ...
  This version has truncated datapaths.

  Author : Matei Istoan

*/

#ifndef FIXEMETHODEVALUATORTRUNC_HPP_
#define FIXEMETHODEVALUATORTRUNC_HPP_
...
namespace flopoco {
  ...
  class FixEMethodEvaluatorTrunc : public Operator
  {
  public:
    /**
     ...
     */
	 FixEMethodEvaluatorTrunc(Target* target,
			size_t radix,
			size_t maxDigit,
			int msbInOut,
			int lsbInOut,
  ...
  private:
    ...
    mpfr_t mpDelta;                   /**< the multi-precision version of delta */
    double alpha;                     /**< the parameter alpha in the E-Method algorithm */
    mpfr_t mpAlpha;                   /**< the multi-precision version of alpha */
    double xi;                        /**< the parameter xi in the E-Method algorithm */
    mpfr_t mpXi;                      /**< the multi-precision version of xi */
...
#endif /* _FIXEMETHODEVALUATORTRUNC_HPP_ */
