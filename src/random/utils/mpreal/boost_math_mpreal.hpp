...
inline mpreal operator + (const mpreal& r, int t){ return r + mpreal(t); }
inline mpreal operator - (const mpreal& r, int t){ return r - mpreal(t); }
inline mpreal operator * (const mpreal& r, int t){ return r * mpreal(t); }
inline mpreal operator / (const mpreal& r, int t){ return r / mpreal(t); }

inline mpreal operator + (const mpreal& r, unsigned t){ return r + mpreal(t); }
inline mpreal operator - (const mpreal& r, unsigned t){ return r - mpreal(t); }
inline mpreal operator * (const mpreal& r, unsigned t){ return r * mpreal(t); }
inline mpreal operator / (const mpreal& r, unsigned t){ return r / mpreal(t); }

inline mpreal operator + (const mpreal& r, double t){ return r + mpreal(t); }
inline mpreal operator - (const mpreal& r, double t){ return r - mpreal(t); }
inline mpreal operator * (const mpreal& r, double t){ return r * mpreal(t); }
inline mpreal operator / (const mpreal& r, double t){ return r / mpreal(t); }
...
inline mpreal operator + (int t, const mpreal& r){ return r + mpreal(t); }
inline mpreal operator * (int t, const mpreal& r){ return r * mpreal(t); }

inline mpreal operator + (unsigned t, const mpreal& r){ return r + mpreal(t); }
inline mpreal operator * (unsigned t, const mpreal& r){ return r * mpreal(t); }

inline mpreal operator + (double t, const mpreal& r){ return r + mpreal(t); }
inline mpreal operator * (double t, const mpreal& r){ return r * mpreal(t); }
...
inline bool operator <= (const mpreal& r, const double& t){ return r <= mpreal(t); }
inline bool operator <= (const mpreal& r, const int& t){ return r <= mpreal(t); }
...
{
   return (boost::math::trunc(x, pol)).toLong();
}
...
inline mpfr::mpreal real_cast<mpfr::mpreal, long long>(long long t)
{
   ...
   while(t)
   {
      ...
      // DT10 : THese were originally 32... Doesn't fit with the mask above
      expon += 16;
      t >>= 16;
   }
   if(sign==-1)
