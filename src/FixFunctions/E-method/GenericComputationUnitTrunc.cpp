...
#include "GenericComputationUnitTrunc.hpp"

namespace flopoco {

	GenericComputationUnitTrunc::GenericComputationUnitTrunc(Target* target, size_t _radix, int _maxDigit,
...
//		//--------- pipelining
	...
	GenericComputationUnitTrunc::~GenericComputationUnitTrunc() {
		//mpfr_clear(mpQi);
	}


	void GenericComputationUnitTrunc::emulate(TestCase * tc)
	{
	...
	OperatorPtr GenericComputationUnitTrunc::parseArguments(Target *target, std::vector<std::string> &args) {
		...
		return new GenericComputationUnitTrunc(target, radix, maxDigit, index, specialCase, W, X, Di, qi);
	}

	void GenericComputationUnitTrunc::registerFactory(){
		UserInterface::add("GenericComputationUnitTrunc", // name
				...
				"",
				"",
				GenericComputationUnitTrunc::parseArguments,
				GenericComputationUnitTrunc::unitTest
		) ;

	}

	TestList GenericComputationUnitTrunc::unitTest(int index)
	{
