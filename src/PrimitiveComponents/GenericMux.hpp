...
///
    ...
    public:
        ...
        ///
        GenericMux(Target* target, const uint32_t &wIn, const uint32_t &inputCount );
    ...
    private:
        ...
        /// \param inputCount The number of inputs of the generated MUX
        ///
        void buildXilinx(Target* target, const uint32_t &wIn, const uint32_t &inputCount);
        ...
        /// \param inputCount The number of inputs of the generated MUX
        ///
        void buildAltera(Target* target, const uint32_t &wIn, const uint32_t &inputCount);
