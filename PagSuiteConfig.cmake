...
FIND_LIBRARY( PAGLIB_LIB NAMES pag libpack.dylib )
FIND_PATH( PAGLIB_INCLUDE_DIR NAMES pagsuite/adder_graph.h )
...
IF( RPAG_FOUND AND PAGLIB_FOUND)
	set(PAGSUITE_FOUND true)
	set(PAGSUITE_LIBRARIES ${RPAG_LIB} ${PAGLIB_LIB} )
	set(PAGSUITE_INCLUDE_DIRS ${RPAG_INCLUDE_DIR} ${PAGLIB_INCLUDE_DIR} )
ENDIF( RPAG_FOUND AND PAGLIB_FOUND )
