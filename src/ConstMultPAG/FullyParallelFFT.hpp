...
namespace flopoco {
	...
	public:
        ...
        FullyParallelFFT(Target* target, int wIn_ = 16, int fftSize_=0, int bC_  =12, int b_=0, int wE_=0, string alg_=0, string rotatorFileName_=0, string FFTAlgorithmFileName_=0, bool intPip_=true);
