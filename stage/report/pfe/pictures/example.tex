...
%	\end{pmatrix}$
		...
		\node[draw, blue!100, fill=green!20, thick, rectangle, minimum width = 3.4*5ex, minimum height=4ex] (d1) at (5em, 13em) {} ;
		  \node (n1) at (5em, 13em)  {\Large $m_{1,1}$} ;
		  \draw[black!25, very thin] ($(n1)-(3.7ex,-1.5ex)$) -- ++(0, -3ex);
		  \draw[black!25, very thin] ($(n1)+(3.7ex, 1.5ex)$) -- ++(0, -3ex);

		\node[draw, blue!100, fill=green!20, thick, rectangle, minimum width = 3.4*4.4ex, minimum height=4ex] (d2) at (9.6em,9em) {} ;
		  \node (n2) at (8em, 9em)  {\large $-j_{2,1}$} ;
		  \node (n3) at (11.2em, 9em)  {\Large $m_{2,2}$} ;
		  \draw[black!25, very thin] ($(n2)+(3.7ex, 1.5ex)$) -- ++(0, -3ex);

		\node[draw, blue!100, fill=green!20, thick, rectangle, minimum width = 3.4*6.5ex, minimum height=4ex] (d3) at (15.2em,5em) {} ;
		...
		\node[draw, blue!100, fill=green!20, thick, rectangle, minimum width = 3.4*8.5ex, minimum height=4ex] (d4) at (24.6em,-1em) {} ;
		...
		\node[draw, blue!100, fill=green!20, thick, rectangle, minimum width = 3.4*10.6ex, minimum height=4ex] (d5) at (34.2em, -8em) {} ;
		...
		\node[draw, green!100, fill=green!20, thick, rectangle, minimum width = 3.4*8.5ex, minimum height=4ex] (d6) at (41.7em, -16em) {} ;
		...
		\node[draw, green!100, fill=green!20, thick, rectangle, minimum width = 3.4*8.5ex, minimum height=4ex] (d7) at (46.7em, -23em) {} ;
		...
		\node[draw, green!100, fill=green!20, thick, rectangle, minimum width = 3.4*8.5ex, minimum height=4ex] (d8) at (51.8em, -29em) {} ;
		...
		\node[draw, green!100, fill=green!20, thick, rectangle, minimum width = 3.4*8.5ex, minimum height=4ex] (d9) at (57.8em, -35em) {} ;
		...
		\node[draw, green!100, fill=green!20, thick, rectangle, minimum width = 3.4*6.5ex, minimum height=4ex] (d10) at (65.2em, -40em) {} ;
		...
		\node[draw, red!100, fill=green!20, thick, rectangle, minimum width = 3.4*6.5ex, minimum height=4ex] (d12) at (5em, -40em) {} ;
